...
export const template = `< !DOCTYPE html >
  ...
  50 % {transform: translateY(-10px) rotate(5deg); }
                  ...
                  < body class="bg-paper text-dark font-sans overflow-hidden antialiased" >
                    ...
                    < !--COVER SCREEN-- >
                    <div id="cover" class="fixed inset-0 z-[100] bg-[url('https://placehold.co/600x800')] bg-cover bg-center h-screen w-full flex flex-col justify-center items-center text-center p-6 before:content-[''] before:absolute before:inset-0 before:bg-dark/40 before:backdrop-blur-[2px]" >
                  ...
                  <main id="mainContent" class="hidden relative" >
                    ...
                    < div class="max-w-4xl mx-auto px-6" >
                      <img src="https://placehold.co/600x800" class="img-organic w-72 h-72 md:w-96 md:h-96 object-cover mx-auto mb-12 border-[12px] border-white shadow-xl" alt="Couple" data - aos="zoom-in" >
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            <img src="prewedding2.jpg" class="w-full rounded-2xl shadow-lg border-4 border-white cursor-pointer hover:-rotate-2 transition" data - aos="fade-up" data - aos - delay="100" onclick = "openModal('prewedding2.jpg')" >
                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                              < div class="space-y-6 pt-12" >
                                                                                                                                                                                                                                <img src="prewedding3.jpg" class="w-full rounded-2xl shadow-lg border-4 border-white cursor-pointer hover:scale-105 transition" data - aos="fade-up" data - aos - delay="200" onclick = "openModal('prewedding3.jpg')" >
                                                                                                                                                                                                                                  <img src="https://placehold.co/600x800" class="w-full rounded-2xl shadow-lg border-4 border-white cursor-pointer hover:rotate-1 transition" data - aos="fade-up" data - aos - delay="300" onclick = "openModal('https://placehold.co/600x800')" >
                                                                                                                                                                                                                                    </div>
